import numpy as np
import pandas as pd
from true_step02_hagan_2002_lognormal_sabr import Hagan2002LognormalSABR # Keep for alpha root finding
from true_step_jax_sabr import compute_sabr_with_jax # New JAX engine
