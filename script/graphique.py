...
# --- ARCHITECTURE (Identique à ton entraînement) ---
...
def generate_final_report():
    print(f"🚀 Génération du rapport comparatif sur {device}...")

    # 1. Chargement des données et config
    ...
    # 5. Préparation des données pour le Step 4 (Gradients numériques bruités)
    # On simule le bruit numérique que TabPFN générerait sans Sobolev
    ...
    print(f"✅ Graphique sauvegardé : {graph_dir / file_name}")
    plt.show()
