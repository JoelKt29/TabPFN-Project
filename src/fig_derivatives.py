...
def show_tabpfn_derivative_noise():
    print("Loading data and training TabPFN...")
    ...
    print("Generating the test scenario...")
    ...
    # =================================================================
    # 2. CAPTURE A CONSISTENT SCENARIO (row 50)
    # =================================================================
    ...
    # =================================================================
    # 3. MATHEMATICAL GROUND TRUTH WITH JAX (lognormal)
    # =================================================================
    ...
    # =================================================================
    # 4. TabPFN PREDICTIONS (normal) AND DERIVATIVE COMPUTATION
    # =================================================================
    ...
    # =================================================================
    # Center and scale both curves so they overlay
